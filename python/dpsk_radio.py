...
# Generated: Thu Dec 17 07:48:25 2015
##################################################
...
class dpsk_radio(gr.hier_block2):
    ...
    def __init__(self, access_code_threshold=0, ampl=0.7, rate=1e6, samps_per_sym=4):
        ...
        self.eb = eb = 0.35
        self.timestamp_microsec = timestamp_microsec = (datetime.now().minute * 60000000) + (datetime.now().second * 1000000) + datetime.now().microsecond 
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, (firdes_tap), 0, samp_rate)
    ...
    def get_timestamp_microsec(self):
        return self.timestamp_microsec

    def set_timestamp_microsec(self, timestamp_microsec):
        self.timestamp_microsec = timestamp_microsec
